...
export const Route = createFileRoute("/airports/ewr")({
  head: () => ({
    meta: [
      { title: "Newark Airport Limo Service | EWR Transfers New Jersey | NY City Limousine" },
      { name: "description", content: "Premium limousine transfers to and from Newark Liberty International Airport (EWR). Flat rates, meet & greet, flight tracking. Book 24/7." },
      { property: "og:title", content: "Newark Airport Limousine Service — NY City Limousine" },
      { property: "og:description", content: "Premium transfers to and from Newark Liberty International Airport (EWR)." },
...
const RATES = [
  { name: "Lincoln Sedan", pax: 3, bags: 3, rate: 95 },
  { name: "Cadillac Sedan", pax: 3, bags: 3, rate: 100 },
  { name: "Chevrolet SUV", pax: 6, bags: 6, rate: 120 },
  { name: "Cadillac Escalade", pax: 6, bags: 6, rate: 130 },
  { name: "Mercedes C Class", pax: 3, bags: 3, rate: 125 },
  { name: "Mercedes S Class", pax: 3, bags: 3, rate: 155 },
  { name: "Black Limousine", pax: 8, bags: 6, rate: 190 },
  { name: "White Stretch Limousine", pax: 7, bags: 6, rate: 190 },
  { name: "Sprinter Van", pax: 14, bags: 12, rate: 230 },
  { name: "Hummer Limousine", pax: 20, bags: 8, rate: 300 },
  { name: "Coach Bus", pax: 50, bags: 50, rate: 600 },
];
  ...
  return (
    <PageShell>
      <PageHero
        ...
        title="Newark Airport Limousine Service"
        subtitle="Newark Liberty International Airport (EWR) — Premium Transfers 24/7"
      ...
      <section className="bg-background py-16">
        <div className="container-luxury mx-auto max-w-3xl text-center">
          <p className="text-lg leading-relaxed text-muted-foreground">
            NY City Limousine provides seamless limousine transfers to and from Newark Liberty International Airport. Our experienced chauffeurs know the best routes to and from EWR ensuring you always arrive on time, stress-free and in complete luxury.
          </p>
          <div className="mt-10">
            ...
            <table className="w-full text-center text-sm">
              <thead className="bg-navy text-white">
                <tr>
                  ...
                  <th className="px-4 py-4 text-gold">EWR Rate</th>
                </tr>
              </thead>
              <tbody>
                {RATES.map((v, i) => (
