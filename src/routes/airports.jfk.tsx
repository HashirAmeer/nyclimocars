...
export const Route = createFileRoute("/airports/jfk")({
  head: () => ({
    meta: [
      { title: "JFK Airport Limo Service | JFK Limousine Transfers New York | NY City Limousine" },
      { name: "description", content: "Premium limousine transfers to and from JFK Airport. Meet & greet, flight tracking, 60 min free wait. All-inclusive rates. Book 24/7." },
      { property: "og:title", content: "JFK Airport Limousine Service — NY City Limousine" },
      { property: "og:description", content: "Premium transfers to and from John F. Kennedy International Airport." },
...
const RATES = [
  { name: "Lincoln Sedan", pax: 3, bags: 3, rate: 85 },
  { name: "Cadillac Sedan", pax: 3, bags: 3, rate: 90 },
  { name: "Chevrolet SUV", pax: 6, bags: 6, rate: 110 },
  { name: "Cadillac Escalade", pax: 6, bags: 6, rate: 120 },
  { name: "Mercedes C Class", pax: 3, bags: 3, rate: 115 },
  { name: "Mercedes S Class", pax: 3, bags: 3, rate: 145 },
  { name: "Black Limousine", pax: 8, bags: 6, rate: 175 },
  { name: "White Stretch Limousine", pax: 7, bags: 6, rate: 175 },
  { name: "Sprinter Van", pax: 14, bags: 12, rate: 210 },
  { name: "Hummer Limousine", pax: 20, bags: 8, rate: 280 },
  { name: "Coach Bus", pax: 50, bags: 50, rate: 550 },
];
  ...
  return (
    <PageShell>
      <PageHero
        ...
        title="JFK Airport Limousine Service"
        subtitle="John F. Kennedy International Airport — Premium Transfers Available 24/7"
      ...
      <section className="bg-background py-16">
        <div className="container-luxury mx-auto max-w-3xl text-center">
          <p className="text-lg leading-relaxed text-muted-foreground">
            NY City Limousine provides premium limousine transfers to and from John F. Kennedy International Airport. JFK is one of the busiest airports in the world — let us take the stress out of your journey. Our professional chauffeurs monitor your flight in real time and meet you inside the terminal with a personalized name sign.
          </p>
          <div className="mt-10">
            ...
            <table className="w-full text-center text-sm">
              <thead className="bg-navy text-white">
                <tr>
                  ...
                  <th className="px-4 py-4 text-gold">JFK Rate</th>
                </tr>
              </thead>
              <tbody>
                {RATES.map((v, i) => (
